namespace TiendaReparaciones
{
    public static class FachadaAparatos
    {
        ...
        public static RepDVD CrearDVD(int nSerie, string modelo, bool blueray, bool graba, int tiempoGrabacion)
        {
            return new RepDVD(nSerie, modelo, blueray, graba,tiempoGrabacion);
        }
        
        public static AdapTDT CrearTDT(int nSerie, string modelo, bool graba, int tiempoGrabacion)
        {
